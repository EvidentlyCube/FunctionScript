package net.retrocade.fusi.parser{
     ...
     *  - Each line can contain only one token (not including nested tokens), so:
     *    GET("x", GET("player"))
     *    is allowed, but:
     ...
     */
    final public class FusiParserAlpha{
        public function FusiParserAlpha(){
        }
        ...
        public function parseScript(script:String):Vector.<FusiBaseToken>{
            ...
            var parsedLines:Vector.<FusiBaseToken> = new Vector.<FusiBaseToken>(lines.length);
